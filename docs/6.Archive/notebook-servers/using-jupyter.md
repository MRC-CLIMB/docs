...
Notebook Servers](installing-software-with-conda.md).
If you have Python packages software in a Conda environment, you 
[can make them available](installing-software-with-conda.md/#using-conda-environments-in-jupyter-notebooks)
