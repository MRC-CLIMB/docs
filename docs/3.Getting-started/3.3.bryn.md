...
+ [**Compute Usage**](3.3.bryn.md#compute-usage)
...
+ [**Compute Usage:**](3.3.bryn.md#compute-usage) Here you can track the teams vCPU usage and currently running tasks.
...
**Read the docs** - Find more information in our documentation.
...
If you click on the tile you can navigate to the [**Compute Usage section**](3.3.bryn.md#compute-usage).

---

## **Compute Usage**

Here you can track the teams vCPU usage and currently running tasks. The dashboard is split into 3 sections; Tasks, Team Compute and Snapshot History.

![**dashboard**](img/compute-1.png)

**1. Tasks**

A summary of vCPUs currently in use for both JupyterLab environments and Nextflow pods for the whole team.

![**dashboard**](img/compute-2.png)

This will update as resource is actively used by all members of the team but may have a slight delay in updating.

**2. Team Compute**

A summary of the number of vCPUS currently in use by the team in relation to your given quota.

![**dashboard**](img/compute-3.png)

**3. Snapshot History**

An overview of total vCPU usage over the last 24 hours. 

![**dashboard**](img/compute-4.png)
...
For more information on Compute Usage and Resource management see our [**JupyterLab page**](../4.Documentation/4.1.JupyterLab/4.1.1.jupyterLab-envs.md#resource-management).
